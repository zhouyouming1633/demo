...
public class ExcelColumnCopyDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        readConfig.put("endData", 35);//数据行结束行
        //数据行从第几行开始读取，如果 dataStart 不配置，则默认从 head + headerRows 后一行开始读数据
        //readConfig.put("dataStart", 5);
        // headerRows 未配置时默认表头占用1行，需要多行表头时再显式配置

        String sourceExcelPath = "\"C:\\Users\\zhouy\\Desktop\\结算单录入-excel\\湖南\\祁阳、永兴、安仁、桃江、新化、益阳6月结算单\\祁阳、永兴、安仁、桃江、新化、益阳6月结算单\\新化晶创-涟源\\新化晶创-涟源-6月份\\新化晶创-涟源供电局-2026-06月.xlsx\"";
